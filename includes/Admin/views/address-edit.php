<div class="wrap">
    <h1><?php _e( 'Edit Address', 'faisal-academy' ); ?></h1>

    <?php if ( isset( $_GET['address-updated'] ) ) { ?>
        <div class="notice notice-success">
            <p><?php _e( 'Address has been updated successfully!', 'faisal-academy' ); ?></p>
        </div>
    <?php } ?>
    ...
    <form action="" method="post">
        ...
        <?php submit_button( __( 'Update Address', 'faisal-academy' ), 'primary', 'submit_address' ); ?>
    </form>
</div>
