...
class Menu {
    ...
    public function admin_menu() {
        ...
        $hook = add_menu_page( __( 'faisal Academy', 'faisal-academy' ), __( 'Academy', 'faisal-academy' ), $capability, $parent_slug, [ $this->addressbook, 'plugin_page' ], 'dashicons-welcome-learn-more' );
